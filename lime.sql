...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-08-14 08:50:50
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(916545, 1, 'Administrator', 'Y', NULL, NULL, 'your-email@example.net', 'N', '', 'A', 'N', 'default', 'zh-Hans', '', 'N', 'N', 'N', 'Y', 0, 'N', 'N', 'N', 'N', 'N', '2015-08-12', 'N', 'N', 'Y', 'N', 'Y', 'N', 'N', 'N', 'N', 'your-email@example.net', NULL, '', '', 15, 'Y', 'B', 'Y', 'X', NULL, 'N', NULL, NULL, NULL, NULL, NULL, 'Y', 'Y', 0, 0, 'N', 'N', '0', '');
