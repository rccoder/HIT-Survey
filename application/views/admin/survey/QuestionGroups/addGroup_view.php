            ...
            <div id="<?php echo $grouplang; ?>">
                <ul>
                    <li>
                        ...
                        <input type='text' size='80' maxlength='100' class='group_title' placeholder='请输入题组名称(如：选择题，填空题，热身题等)' name='group_name_<?php echo $grouplang; ?>' id='group_name_<?php echo $grouplang; ?>' /><span class='annotation'> <?php eT("Required"); ?></span></li>

                    <li style="display:none"><label for='description_<?php echo $grouplang; ?>'><?php eT("Description:"); ?></label>
                    ...
                    <?php if ($grouplang==$baselang){?>
                        <li style="display:none"><label for='randomization_group'><?php eT("Randomization group:"); ?></label><input type='text' size='20' maxlength='20' name='randomization_group' id='randomization_group' /></li>
